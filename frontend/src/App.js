...
kind: "block", type: "turtle_set_background_color"
...

      {
        ...
        contents: [
          ...
          {kind: "block", type: "matplotlib_waitforbuttonpress"},
          {kind: "block", type: "matplotlib_close"},
...

      {
        ...
        contents: [
          ...
          { kind: "block", type: "file_open_write"},
          { kind: "block", type: "read_excel_file"},
          { kind: "block", type: "csv_writer"},
          { kind: "block", type: "csv_writerows"},
...
,

      {
        ...
        "contents": [
          ...
          { kind: "block", type: "cv2_cvtColor", "colour": "#6A5ACD" },
